...
<div class="app flex-row align-items-right" style="min-height:83vh;">
    <div class="container"> 
        ...
        <form action="{{ URL('/pengalaman/update',$experience->id_experience) }}" id="myForm" method="POST" class="horizontal">
            @csrf
                        ...
                        <div class="card-body">                 
                            <div class="row">
                              <div class="form-group col-sm-6">
                                ...
                                <div class="col-form-label">
                                    <div class="form-check form-check-inline mr-1">
                                      <input class="form-check-input" type="radio" id="inline-radio1" value="No" name="freshgraduate" {{ $experience->freshgraduate == 'No' ? 'checked' : ''}}>
                                      <label class="form-check-label " for="inline-radio1 ">No</label>
                                    </div>
                                    <div class="form-check form-check-inline mr-1">
                                      <input class="form-check-input" type="radio" id="inline-radio1" value="Yes" name="freshgraduate" {{ $experience->freshgraduate == 'Yes' ? 'checked' : ''}}>
                              ...
                              <div class="form-group col-sm-6">
                                ...
                                <div class="col-form-label">
                                    <div class="form-check form-check-inline mr-1">
                                      <input class="form-check-input" type="checkbox" id="inline-radio1" value="Bahasa Indonesia" name="language[]" {{ in_array('Bahasa Indonesia',$language) ? 'checked' : '' }}>
                                      <label class="form-check-label " for="inline-radio1 ">Bahasa Indonesia</label>
                                    </div>
                                    <div class="form-check form-check-inline mr-1">
                                      <input class="form-check-input" type="checkbox" id="inline-radio1" value="Bahasa Inggris" name="language[]" {{ in_array('Bahasa Inggris',$language) ? 'checked' : '' }}>
                                ...
                                <div class="form-group col-sm-6">
                                    <label for="programming">Pengalaman Dalam Bahasa Pemrograman</label>
                                        <select id="programming" name="programming" class="form-control"> 
                                            ...
                                            @foreach ($programming as $id_programming => $name_programming)
                                                <option value="{{ $id_programming }}"
                                                    @if ($id_programming==$experience->programming)
                                                        selected
                                                    @endif
                                                >
                                                    {{ $name_programming }}
